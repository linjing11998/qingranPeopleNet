    ...
    <el-container style="padding:20px;">
      <el-aside width="340px" style="padding:20px;background-color: white;">
        ...
        <el-row style="margin-top: 10px;">
          ...
          <!-- <el-button icon="el-icon-files" size="small" class='btns' @click="handleDownload('xlsx')">导出</el-button> -->
        </el-row>
        <el-row>
          <el-table :data="tableData.slice((this.page - 1) * 10, (this.page - 1) * 10 + 10)" style="width: 100%" height="528px" @cell-click="handle" :row-class-name="tableRowClassName" highlight-current-row>
            ...
            <el-table-column prop="lng" label="精度"></el-table-column>
      ...
      <el-main style="position: relative;padding:0px">
        ...
        <div class="playSpeed">
          <!-- <div style="width: 90%;align-items: center;justify-content: center; display:flex;height:48px;position: absolute; bottom: 2%;left:5%;background-color: #fff;box-shadow: 0 2px 4px rgba(0, 0, 0, .12)"> -->
          <!-- 开始暂停按钮 -->
